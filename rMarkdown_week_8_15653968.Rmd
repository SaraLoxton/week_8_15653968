---
title: "Week 8 - GIS with Leaflet in R"
author: "Sara Loxton"
date: "`r Sys.Date()`"
...
## Task Five:
```{r}
# making the plot for the territories
...
## Task Six:
```{r}
#Colelcting the data from the csv
...
#checking again because im stressed again
...
#Im stressed again and checking, this comes up on the side enviroment menu
...
## Task Eight:
```{r}
# choropleth map with non-transformed population count
...
p_jazzy <- ggplot(nz_joined) +
  ...
  scale_fill_viridis_c(
    ...
    labels  = scales::label_comma(), # pretty numbers, boom
    option  = "C",
    na.value = "grey90",
...
#dont worry this also has been jazzed up
p_jazzy
```

```{r}
# I moved this to another code structure so I dont download it multiple times.
